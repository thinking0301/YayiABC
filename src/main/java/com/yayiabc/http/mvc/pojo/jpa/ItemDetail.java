...
public class ItemDetail extends BasePojo {
	...
	public String getIetmRange() {
		return ietmRange;
	}

	public void setIetmRange(String ietmRange) {
		this.ietmRange = ietmRange == null ? null : ietmRange.trim();
	}
	...
	public ItemDetail(String itemId, String video, String itemPica,
			...
			String itemPacking, String itemLevels, String ietmRange,
	...
	public String toString() {
		return "ItemDetail [itemId=" + itemId + ", video=" + video
				...
				+ itemPacking + ", itemLevels=" + itemLevels + ", ietmRange="
				+ ietmRange + ", remark=" + remark + ", itemDesc=" + itemDesc
				+ ", itemUse=" + itemUse + "]";
	}
