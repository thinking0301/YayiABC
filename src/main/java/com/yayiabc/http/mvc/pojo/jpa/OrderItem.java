...
public class OrderItem extends BasePojo {
	...
	public void setOrdera(Ordera order) {
		this.order = order;
	}
	...
	public OrderItem(String itemId, Ordera order, Integer qbDed, Integer num,
	...
	public String toString() {
		return "OrderItem [itemId=" + itemId + ", order=" + order + ", qbDed="
				+ qbDed + ", num=" + num + ", price=" + price + ", totalFee="
				+ totalFee + ", picPath=" + picPath + "]";
	}
